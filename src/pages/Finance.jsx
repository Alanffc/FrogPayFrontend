...
import { 
  ...
  CreditCard, FileText, FileSpreadsheet, ChevronDown, Menu
} from 'lucide-react';
    ...
    <div className="relative min-h-[calc(100vh-2rem)] w-full overflow-hidden p-4 sm:p-6 lg:p-8">
      ...
      <div className="relative z-10 mx-auto max-w-7xl space-y-6 sm:space-y-8">
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          {/* Main Chart */}
          <div className="rounded-3xl border border-white/5 bg-white/[0.02] p-6 sm:p-8 backdrop-blur-xl flex flex-col transition-all duration-500 hover:border-white/10 hover:shadow-[0_10px_50px_rgba(0,0,0,0.2)] w-full overflow-hidden">
