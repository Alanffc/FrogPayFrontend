...
export default function LoginModal({ isOpen, onClose }) {
  ...
  const handleSubmit = (event) => {
    ...
    if (!hasError) {
      console.log('Intento de login con:', { email, password, rememberMe });
      onClose(); 
    }
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-black/60 backdrop-blur-sm">
      <div className="relative w-full max-w-5xl rounded-[2.5rem] overflow-hidden border border-white/10 bg-black/70 shadow-[0_40px_120px_rgba(0,0,0,0.55)] backdrop-blur-xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-0 lg:gap-6">
          ...
          <div className="relative z-10 p-8 lg:p-14 flex flex-col justify-between gap-8">
            ...
            <div>
              ...
              <h2 className="mt-6 text-4xl font-black tracking-tight text-white leading-tight">
            ...
            >
              ...
              <label className="grid gap-2 text-sm text-gray-300">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 inline-flex items-center justify-center text-[#e6ff2a] transition hover:text-[#b7f758]"
              ...
              <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between mt-4">
                <div className="text-sm text-gray-400">
                  ¿No tienes cuenta?{' '}
                  <button type="button" className="text-white font-medium hover:text-[#e6ff2a] transition">
                    Regístrate
                  </button>
                </div>
