const STORAGE_KEYS = {
  backendUrl: 'tamiga_admin_backend_url',
  apiKey: 'tamiga_admin_api_key',
  limit: 'tamiga_admin_limit',
  refreshSeconds: 'tamiga_admin_refresh_seconds',
  ngrokUrl: 'tamiga_admin_ngrok_url',
  notificationsEnabled: 'tamiga_admin_notifications_enabled',
  remember: 'tamiga_admin_remember',
};
